...
#line 742
typedef int (*__compar_fn_t)(const void *arg_0x7f5ca4cfd020, const void *arg_0x7f5ca4cfd320);
#line 780
__extension__ 
#line 797
__extension__ 
...
#line 250
extern double erfc(double arg_0x7f5ca4c755e0) __attribute((__leaf__)) __attribute((__nothrow__)) ;
#line 326
__extension__ 
...
unsigned int (*hashfunction)(void *arg_0x7f5ca4a183a0), 
int (*key_eq_fn)(void *arg_0x7f5ca4a18b70, void *arg_0x7f5ca4a18e30));
#line 103
#line 102
int 
...
static inline void RandomInitialise(int arg_0x7f5ca4805c00, int arg_0x7f5ca4805e80);
static double RandomUniform(void );
...
typedef pack /*NodeC.list*/ListC__0__t;
typedef /*NodeC.list*/ListC__0__t /*NodeC.list*/ListC__0__List__t;
...
static uint16_t /*NodeC.list*/ListC__0__List__size(void );
static /*NodeC.list*/ListC__0__List__t /*NodeC.list*/ListC__0__List__get(uint16_t position);
#line 17
static void /*NodeC.list*/ListC__0__List__pushback(/*NodeC.list*/ListC__0__List__t input);
...
#line 17
static void Node__list__pushback(Node__list__t input);
...
uint16_t /*NodeC.list*/ListC__0__MAX_SIZE[1000];

/*NodeC.list*/ListC__0__t /*NodeC.list*/ListC__0__container[1000][40];
uint16_t /*NodeC.list*/ListC__0__size[1000];

static void /*NodeC.list*/ListC__0__List__pushback(/*NodeC.list*/ListC__0__t input);
#line 87
static inline uint16_t /*NodeC.list*/ListC__0__List__size(void );



static inline /*NodeC.list*/ListC__0__t /*NodeC.list*/ListC__0__List__get(uint16_t position);
#line 16
...
inline static void Node__list__pushback(Node__list__t input){
#line 17
  /*NodeC.list*/ListC__0__List__pushback(input);
#line 17
}
#line 17
...
#line 91
{
  return /*NodeC.list*/ListC__0__container[sim_node()][position];
}
...
#line 25
  __nesc_result = /*NodeC.list*/ListC__0__List__get(position);
#line 25
...
#line 87
{
  return /*NodeC.list*/ListC__0__size[sim_node()];
}
...
#line 24
  __nesc_result = /*NodeC.list*/ListC__0__List__size();
#line 24
...
#line 206
  for (i = 0; i < Node__list__size(); i++) {
      pack current = Node__list__get(i);
...
#line 92
            if (__nesc_ntoh_uint16(myMsg->dest.nxdata) != __nesc_ntoh_uint16(myMsg->src.nxdata) && __nesc_ntoh_uint16(myMsg->dest.nxdata) != AM_BROADCAST_ADDR && __nesc_ntoh_uint8(myMsg->protocol.nxdata) == 0) {
                Node__makePack(&Node__sendPackage[sim_node()], __nesc_ntoh_uint16(myMsg->src.nxdata), __nesc_ntoh_uint16(myMsg->dest.nxdata), (__nesc_temp42 = myMsg->TTL.nxdata, __nesc_hton_uint8(__nesc_temp42, (__nesc_temp43 = __nesc_ntoh_uint8(__nesc_temp42) - 1)), __nesc_temp43), 0, __nesc_ntoh_uint16(myMsg->seq.nxdata), myMsg->payload, PACKET_MAX_PAYLOAD_SIZE);
                Node__list__pushback(Node__sendPackage[sim_node()]);
...
#line 105
                    if (__nesc_ntoh_uint8(myMsg->protocol.nxdata) == 1) {
                        ...
                        if (Node__neighborList__get(TOS_NODE_ID) != __nesc_ntoh_uint16(myMsg->src.nxdata) && Node__neighborList__get(TOS_NODE_ID - 1) != __nesc_ntoh_uint16(myMsg->src.nxdata)) {
                          Node__neighborList__pushback(__nesc_ntoh_uint16(myMsg->src.nxdata));
                          }
#line 109
                        Node__makePack(&Node__sendPackage[sim_node()], TOS_NODE_ID, AM_BROADCAST_ADDR, (__nesc_temp44 = myMsg->TTL.nxdata, __nesc_hton_uint8(__nesc_temp44, (__nesc_temp45 = __nesc_ntoh_uint8(__nesc_temp44) - 1)), __nesc_temp45), 2, (__nesc_temp46 = myMsg->seq.nxdata, __nesc_hton_uint16(__nesc_temp46, (__nesc_temp47 = __nesc_ntoh_uint16(__nesc_temp46) + 1)), __nesc_temp47), myMsg->payload, PACKET_MAX_PAYLOAD_SIZE);
                        Node__list__pushback(Node__sendPackage[sim_node()]);
                        Node__Sender__send(Node__sendPackage[sim_node()], __nesc_ntoh_uint16(myMsg->src.nxdata));

                        Node__makePack(&Node__sendPackage[sim_node()], TOS_NODE_ID, AM_BROADCAST_ADDR, 2, 1, (__nesc_temp48 = myMsg->seq.nxdata, __nesc_hton_uint16(__nesc_temp48, (__nesc_temp49 = __nesc_ntoh_uint16(__nesc_temp48) + 1)), __nesc_temp49), myMsg->payload, PACKET_MAX_PAYLOAD_SIZE);
                        Node__list__pushback(Node__sendPackage[sim_node()]);
                        Node__Sender__send(Node__sendPackage[sim_node()], AM_BROADCAST_ADDR);
...
#line 123
                          if (__nesc_ntoh_uint16(myMsg->src.nxdata) != 19) {
                              Node__makePack(&Node__sendPackage[sim_node()], TOS_NODE_ID, AM_BROADCAST_ADDR, (__nesc_temp50 = myMsg->TTL.nxdata, __nesc_hton_uint8(__nesc_temp50, (__nesc_temp51 = __nesc_ntoh_uint8(__nesc_temp50) - 1)), __nesc_temp51), 1, (__nesc_temp52 = myMsg->seq.nxdata, __nesc_hton_uint16(__nesc_temp52, (__nesc_temp53 = __nesc_ntoh_uint16(__nesc_temp52) + 1)), __nesc_temp53), myMsg->payload, PACKET_MAX_PAYLOAD_SIZE);
                              Node__list__pushback(Node__sendPackage[sim_node()]);
                              Node__Sender__send(Node__sendPackage[sim_node()], AM_BROADCAST_ADDR);
                            }
                          return msg;
...
#line 138
                  if (__nesc_ntoh_uint16(myMsg->dest.nxdata) != __nesc_ntoh_uint16(myMsg->src.nxdata) && __nesc_ntoh_uint16(myMsg->dest.nxdata) != AM_BROADCAST_ADDR && __nesc_ntoh_uint8(myMsg->protocol.nxdata) == 0) {
                      Node__makePack(&Node__sendPackage[sim_node()], __nesc_ntoh_uint16(myMsg->src.nxdata), __nesc_ntoh_uint16(myMsg->dest.nxdata), (__nesc_temp54 = myMsg->TTL.nxdata, __nesc_hton_uint8(__nesc_temp54, (__nesc_temp55 = __nesc_ntoh_uint8(__nesc_temp54) - 1)), __nesc_temp55), 0, __nesc_ntoh_uint16(myMsg->seq.nxdata), myMsg->payload, PACKET_MAX_PAYLOAD_SIZE);
                      Node__list__pushback(Node__sendPackage[sim_node()]);
                      sim_log_debug(117U, FLOODING_CHANNEL, "Flooding Packet Received at Node %d for Node %d. Resending..\n", TOS_NODE_ID, __nesc_ntoh_uint16(myMsg->dest.nxdata));
                      Node__Sender__send(Node__sendPackage[sim_node()], AM_BROADCAST_ADDR);
                      sim_log_debug(118U, FLOODING_CHANNEL, "Flooding Packet sent from Node %d to Node %d \n", TOS_NODE_ID, __nesc_ntoh_uint16(myMsg->dest.nxdata));
                      return msg;
                    }
                  }
                }
...
#line 147
  ...
  sim_log_debug(119U, GENERAL_CHANNEL, "Unknown Packet Type %d\n", len);
  return msg;
}
...
# 78 "/opt/tinyos-main/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC__Receive__receive(am_id_t arg_0x7f5ca44f6e30, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0x7f5ca44f6e30) {
#line 78
    case 6:
#line 78
...
#line 78
    default:
#line 78
      __nesc_result = TossimActiveMessageC__Receive__default__receive(arg_0x7f5ca44f6e30, msg, payload, len);
#line 78
      break;
#line 78
    }
...
# 78 "/opt/tinyos-main/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC__Snoop__receive(am_id_t arg_0x7f5ca44f5a50, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = TossimActiveMessageC__Snoop__default__receive(arg_0x7f5ca44f5a50, msg, payload, len);
#line 78
...
# 110 "/opt/tinyos-main/tos/interfaces/AMSend.nc"
inline static void TossimActiveMessageC__AMSend__sendDone(am_id_t arg_0x7f5ca4510c70, message_t * msg, error_t error){
#line 110
  /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__AMSend__sendDone(arg_0x7f5ca4510c70, msg, error);
#line 110
}
#line 110
...
#line 88
# 80 "/opt/tinyos-main/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__AMSend__send(am_id_t arg_0x7f5ca3df1b60, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = TossimActiveMessageC__AMSend__send(arg_0x7f5ca3df1b60, addr, msg, len);
#line 80
...
#line 133
        {
          ...
          sim_log_debug(159U, GENERAL_CHANNEL, "The radio is busy, or something\n");
          return FAIL;
        }
    }
  else 
#line 138
    {
      sim_log_debug(160U, GENERAL_CHANNEL, "The radio is busy");
      return EBUSY;
    }


  sim_log_debug(161U, GENERAL_CHANNEL, "FAILED!?");
  return FAIL;
}
...
# 100 "/opt/tinyos-main/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__Send__sendDone(uint8_t arg_0x7f5ca3df2940, message_t * msg, error_t error){
#line 100
  switch (arg_0x7f5ca3df2940) {
#line 100
    case 0U:
#line 100
...
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__Send__default__sendDone(arg_0x7f5ca3df2940, msg, error);
#line 100
      break;
#line 100
    }
...
#line 170
  sim_log_debug(122U, NEIGHBOR_CHANNEL, "Neighbor list for Node %d\n", TOS_NODE_ID);
  i = TOS_NODE_ID;
  if (TOS_NODE_ID == 1) {
    sim_log_debug(123U, NEIGHBOR_CHANNEL, "Neighbors:%d\n", Node__neighborList__get(1));
    }
  else {
#line 174
    if (TOS_NODE_ID == 19) {
      sim_log_debug(124U, NEIGHBOR_CHANNEL, "Neighbors:%d\n", Node__neighborList__get(18));
      }
    else {
#line 177
      sim_log_debug(125U, NEIGHBOR_CHANNEL, "Neighbors:%d, %d\n", Node__neighborList__get(TOS_NODE_ID), Node__neighborList__get(TOS_NODE_ID - 1));
      }
    }
}
...
#line 158
{
  ...
  sim_log_debug(120U, FLOODING_CHANNEL, "Flooding Network... \n");
  ...
  Node__list__pushback(Node__sendPackage[sim_node()]);
  Node__Sender__send(Node__sendPackage[sim_node()], AM_BROADCAST_ADDR);
  sim_log_debug(121U, FLOODING_CHANNEL, "Flooding Packet sent from Node %d to Node %d \n", TOS_NODE_ID, destination);
}
...
#line 22
{
  if (!CommandHandlerP__Queue__empty()) {
      ...
      sim_log_debug(178U, COMMAND_CHANNEL, "A Command has been Issued.\n");
      ...
      switch (commandID) {
          ...
          case CMD_PING: 
            sim_log_debug(179U, COMMAND_CHANNEL, "Command Type: Ping\n");
          CommandHandlerP__CommandHandler__ping(buff[0], &buff[1]);
          break;

          case CMD_NEIGHBOR_DUMP: 
            sim_log_debug(180U, COMMAND_CHANNEL, "Command Type: Neighbor Dump\n");
          CommandHandlerP__CommandHandler__printNeighbors();
          break;

          case CMD_LINKSTATE_DUMP: 
            sim_log_debug(181U, COMMAND_CHANNEL, "Command Type: Link State Dump\n");
          CommandHandlerP__CommandHandler__printLinkState();
          break;

          case CMD_ROUTETABLE_DUMP: 
            sim_log_debug(182U, COMMAND_CHANNEL, "Command Type: Route Table Dump\n");
          CommandHandlerP__CommandHandler__printRouteTable();
          break;

          case CMD_TEST_CLIENT: 
            sim_log_debug(183U, COMMAND_CHANNEL, "Command Type: Client\n");
          CommandHandlerP__CommandHandler__setTestClient();
          break;

          case CMD_TEST_SERVER: 
            sim_log_debug(184U, COMMAND_CHANNEL, "Command Type: Client\n");
          CommandHandlerP__CommandHandler__setTestServer();
          break;

          default: 
            sim_log_debug(185U, COMMAND_CHANNEL, "CMD_ERROR: \"%d\" does not match any known commands.\n", __nesc_ntoh_uint8(msg->id.nxdata));
          break;
        }
      CommandHandlerP__Pool__put(raw_msg);
    }
...
# 75 "/opt/tinyos-main/tos/interfaces/TaskBasic.nc"
inline static void SimSchedulerBasicP__TaskBasic__runTask(uint8_t arg_0x7f5ca46d9020){
#line 75
  switch (arg_0x7f5ca46d9020) {
#line 75
...
#line 75
    default:
#line 75
      SimSchedulerBasicP__TaskBasic__default__runTask(arg_0x7f5ca46d9020);
#line 75
      break;
#line 75
    }
...
#line 218
  Node__neighborList__pushback(TOS_NODE_ID);
...
# 83 "/opt/tinyos-main/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__fired(uint8_t arg_0x7f5ca3f70950){
#line 83
  switch (arg_0x7f5ca3f70950) {
#line 83
    case 0U:
#line 83
      Node__Timer0__fired();
...
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__default__fired(arg_0x7f5ca3f70950);
#line 83
      break;
#line 83
    }
...
{
  Node__AMControl__start();
  Node__Timer0__startPeriodic(300000);
...
#line 76
  sim_log_debug(190U, "QueueC", "head <-");
...
#line 81
          sim_log_debug_clear(192U, "QueueC", "%0.2hhx", v);
        }
      sim_log_debug_clear(193U, "QueueC", "] ");
    }
  sim_log_debug_clear(194U, "QueueC", "<- tail\n");
}
...
#line 21
{
  ...
  if (/*NodeC.list*/ListC__0__size[sim_node()] < /*NodeC.list*/ListC__0__MAX_SIZE[sim_node()]) {

      /*NodeC.list*/ListC__0__container[sim_node()][/*NodeC.list*/ListC__0__size[sim_node()]] = input;
      /*NodeC.list*/ListC__0__size[sim_node()]++;
    }
}
...
#line 76
  sim_log_debug(171U, "QueueC", "head <-");
  for (i = /*NodeC.SimpleSendC.QueueC*/QueueC__1__head[sim_node()]; i < /*NodeC.SimpleSendC.QueueC*/QueueC__1__head[sim_node()] + /*NodeC.SimpleSendC.QueueC*/QueueC__1__size[sim_node()]; i++) {
      sim_log_debug_clear(172U, "QueueC", "[");
...
#line 81
          sim_log_debug_clear(173U, "QueueC", "%0.2hhx", v);
        }
      sim_log_debug_clear(174U, "QueueC", "] ");
    }
  sim_log_debug_clear(175U, "QueueC", "<- tail\n");
}
                               ...
                               uintptr_t* addr, size_t* size)
{
  ...
  /* Module ListC__0 */
  if (!strcmp(varname, "/*NodeC.list*/ListC__0__MAX_SIZE"))
  {
    *addr = (uintptr_t)&/*NodeC.list*/ListC__0__MAX_SIZE[__nesc_mote];
    *size = sizeof(/*NodeC.list*/ListC__0__MAX_SIZE[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "/*NodeC.list*/ListC__0__container"))
  {
    *addr = (uintptr_t)&/*NodeC.list*/ListC__0__container[__nesc_mote];
    *size = sizeof(/*NodeC.list*/ListC__0__container[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "/*NodeC.list*/ListC__0__size"))
  {
    *addr = (uintptr_t)&/*NodeC.list*/ListC__0__size[__nesc_mote];
    *size = sizeof(/*NodeC.list*/ListC__0__size[__nesc_mote]);
    return 0;
  }
...
static void __nesc_nido_initialise(int __nesc_mote)
{
  ...
  /* Module ListC__0 */
  /*NodeC.list*/ListC__0__MAX_SIZE[__nesc_mote] = 40;
  memset((void *)&/*NodeC.list*/ListC__0__container[__nesc_mote], 0, sizeof /*NodeC.list*/ListC__0__container[__nesc_mote]);
  /*NodeC.list*/ListC__0__size[__nesc_mote] = 0;
